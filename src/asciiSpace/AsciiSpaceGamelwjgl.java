...
public class AsciiSpaceGamelwjgl {
	...
	private static void checkInput(float delta) {
		...
		w.pl.wombat = w.pl.wombat ^ Keyboard.isKeyDown(Keyboard.KEY_R);
		
		if (Keyboard.isKeyDown(Keyboard.KEY_COMMA))
		{
			cam.setFov(181);
			cam.applyPerspectiveMatrix();
			w.pl.processKeyboard(delta, 0.3f, 0.3f, 0.3f,cam);
		}
		else if (w.pl.wombat)
		{
			cam.setFov(75);
		...
		} else
		{
			cam.setFov(70);
			cam.applyPerspectiveMatrix();
			w.pl.processKeyboard(delta, 0.003f, 0.003f, 0.003f,cam);
		}
